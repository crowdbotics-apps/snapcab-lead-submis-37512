...
## Project Structure
    ...
    ├── snapcab_lead_submis_37512  # Django project configurations
...
1. Clone this repo and `cd snapcab_lead_submis_37512`
...
2. Clone this repo and `cd snapcab_lead_submis_37512`
